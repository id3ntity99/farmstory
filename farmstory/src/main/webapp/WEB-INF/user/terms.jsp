<%@page import="farmstory.dto.TermDTO"%> <%@page import="java.util.List"%> <%@
taglib prefix="c" uri="jakarta.tags.core" %> <%@ page
contentType="text/html;charset=UTF-8" pageEncoding="UTF-8"%> <% List<TermDTO>
  termsList = (List<TermDTO
    >) request.getAttribute("terms"); pageContext.setAttribute("terms",
    termsList); %>
    <!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <script
          ...
          src="/farmstory/js/terms/terms.js"
        ></script>
      </head>
      <body>
        <div id="wrapper">
            ...
            <section class="services">
              <article>
                ...
                <div>
                  <a href="#">
                    <img
                      src="/farmstory/images/head_menu_badge.png"
                      alt="30%"
                    />
                  </a>
                </div>
