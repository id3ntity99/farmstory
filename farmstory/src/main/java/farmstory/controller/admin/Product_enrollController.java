...
public class Product_enrollController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			logger.info("thumbnailLocation = {}", thumbnailLocation);
			logger.info("infoLocation = {}", infoLocation);
			logger.info("detailLocation = {}", detailLocation);
	        ...
	        if (imageDTO.getThumbnailLocation() != null || imageDTO.getInfoLocation() != null || imageDTO.getDetailLocation() != null) {
	        	logger.debug("productImageDAO.insertProductImage...1");
	        	
	            productImageDAO.insertProductImage(imageDTO);
	            
	            logger.debug("productImageDAO.insertProductImage...2");
	        }
